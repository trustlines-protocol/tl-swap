...
function Step1(props: {
    ...
    const [qrCodeScannerContext, setQrCodeScannerContext] = React.useState<"yourTLAddress" | "counterpartyTLAddress">("yourTLAddress");
    ...
    React.useEffect(() => {
        if (status === "success") {
            onChangeNetwork(data[0].address);
        }
    }, [status, data, onChangeNetwork]);
